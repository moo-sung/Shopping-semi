				...
				<div class="main">
					...
					<div class="orderListArea">
								...
								<tfoot class="right">
									<tr>
										<td colspan="9"><span class="gLeft">[기본배송]</span> 상품구매금액
											<strong> 00,000 <span class="displaynone">
													(0)</span>
								...
								<tbody class="tablein">
									<tr class="xans-record-">
										<td class=""><input id="chk_order_cancel_list0"
											name="chk_order_cancel_list_basic0" value="497:000G:F:52324"
											type="checkbox"></td>
						...
						<div class="ec-base-button">
							<span style="font-size: 11px"> 선택상품을 
							<a href="#none" id="btn_product_delete" class="btnEm"><strong>삭제하기</strong></a>
							</span>
						</div>
									...
									<tbody class="">
										...
										<tr>
											...
											<td><input id="rzipcode1" name="rzipcode1"
												...
												<span class="grid" style="font-size:12px;">기본주소</span> <br> <input id="raddr2"
												name="raddr2" fw-filter="" fw-label="수취자 주소2" fw-msg=""
												class="inputTypeText" placeholder="" size="40" value=""
												type="text"> <span class="grid" style="font-size:12px;">나머지주소</span> <span
