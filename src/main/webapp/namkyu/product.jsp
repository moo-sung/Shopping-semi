    ...
    <div id="container">  
      ...
      <div id="content">   
        ...
        <%-- 제품페이지 --%>
        	<div id="contentArea">
        		<div class="mainImg">
        			<img src="https://via.placeholder.com/400x600" alt="메인 이미지"/>
        		</div>
        		<div class="infoArea" id="buy">
	        		...
	        		<div class="price">
	        			...
	        			<form method="get" id="formAction">
	        				<%-- 제품코드 --%>
	        				<label></label>
	        				<input id="idx" name="idx" type="hidden" value=<%=productIdx %>>	
	        				<%-- 제품가격 --%>
	        				<label></label>
        	...
        	<div id="moveBtn" class="btn">
        		...
        		<a href="<%=request.getContextPath()%>/wontack/review.jsp">리뷰 보러가기</a>
        	</div>
        ...
        <%-- 제품설명 --%>
			...
			<%-- 이미지 삽입(더미 이미지) --%>
				<div class="img1" id="img1">
					<p><img src="https://via.placeholder.com/700x900"/></p>
					<p><img src="https://via.placeholder.com/700x900"/></p>
					<p><img src="https://via.placeholder.com/700x900"/></p>
					<p><img src="https://via.placeholder.com/700x900"/></p>				
				</div>
				<div class="img2" id="img2">
					<p><img src="https://via.placeholder.com/600x800"/></p>
					<p><img src="https://via.placeholder.com/600x800"/></p>
					<p><img src="https://via.placeholder.com/600x800"/></p>
					<p><img src="https://via.placeholder.com/600x800"/></p>				
				</div>
...
<script type="text/javascript">
	...
	function priceSelect() {
		...
		/* document.getElementById("productIdx").setAttribute("value", code); */
	...
	$("#buyBtn").click(function() {
		...
		if(!confirm("구매페이지로 이동하시겠습니까?")) {
			...
			$("#formAction").attr("action", "<%=request.getContextPath()%>/moonhee/order.jsp");
			$("#formAction").submit();	  
		}
	})
	...
	$("#cartBtn").click(function() {
		...
		if(!confirm("장바구니로 이동하시겠습니까?")) {
			...
			$("#formAction").attr("action", "product_cart_action.jsp");
			$("#formAction").submit();	  
		}
	});
